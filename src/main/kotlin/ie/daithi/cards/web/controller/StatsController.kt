...
class StatsController(
    ...
    @Operation(summary = "Game stats for current player", description = "Returns the game stats for the current player")
    @ApiResponses(
    ...
    @ResponseStatus(value = HttpStatus.OK)
    @Operation(summary = "Game stats for given player player", description = "Returns the game stats for the given player")
    @ApiResponses(
        ApiResponse(responseCode = "200", description = "Request successful")
    )
    @ResponseBody
