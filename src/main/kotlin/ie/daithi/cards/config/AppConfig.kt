...
class AppConfig(
    ...
    fun redisConnectionFactory(): RedisConnectionFactory {
        ...
        val redisUri =
            if (redisTlsUriString != null) RedisURI.create(redisTlsUriString)
            else RedisURI.create(redisUriString)
        ...
        val clientConfig =
            ...
            else LettuceClientConfiguration.builder().build()
    ...
    ): RedisTemplate<String, WsMessage> {
